 ...
 */
public final class SelfContainedMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ServerEnvironment serverEnvironment = determineEnvironment(args, WildFlySecurityManager.getSystemPropertiesPrivileged(), WildFlySecurityManager.getSystemEnvironmentPrivileged(), ServerEnvironment.LaunchType.SELF_CONTAINED);
                ...
                configuration.setConfigurationPersisterFactory(
                        new Bootstrap.ConfigurationPersisterFactory() {
                            ...
                            public ExtensibleConfigurationPersister createConfigurationPersister(ServerEnvironment serverEnvironment, ExecutorService executorService) {
                                SelfContainedConfigurationPersister persister = new SelfContainedConfigurationPersister();
