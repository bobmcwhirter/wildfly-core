 ...
 */
public class EmbeddedContentRepository implements ContentRepository, Service<ContentRepository> {

    public static void addService(ServiceTarget serviceTarget) {
        EmbeddedContentRepository contentRepository = new EmbeddedContentRepository();
